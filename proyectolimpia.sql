...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-04-2018 a las 19:46:53
...
--
ALTER TABLE `fan`
  MODIFY `id_fan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `foro_favs`
--
ALTER TABLE `foro_favs`
  MODIFY `id_favs` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `foro_respuesta`
  MODIFY `id_fororespuesta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
...
--
ALTER TABLE `reportes_comentarios`
  ADD CONSTRAINT `reportes_comentarios_ibfk_1` FOREIGN KEY (`id_comentario`) REFERENCES `comentario` (`id_comentario`),
  ADD CONSTRAINT `reportes_comentarios_ibfk_2` FOREIGN KEY (`id_reportado`) REFERENCES `usuario` (`id_usuario`),
  ADD CONSTRAINT `reportes_comentarios_ibfk_3` FOREIGN KEY (`id_reportero`) REFERENCES `usuario` (`id_usuario`);

--
-- Filtros para la tabla `reportes_publicaciones`
--
ALTER TABLE `reportes_publicaciones`
  ADD CONSTRAINT `reportes_publicaciones_ibfk_1` FOREIGN KEY (`id_publicacion`) REFERENCES `publicacion` (`id_publicacion`),
  ADD CONSTRAINT `reportes_publicaciones_ibfk_2` FOREIGN KEY (`id_reportado`) REFERENCES `usuario` (`id_usuario`),
  ADD CONSTRAINT `reportes_publicaciones_ibfk_3` FOREIGN KEY (`id_reportero`) REFERENCES `usuario` (`id_usuario`);

--
-- Filtros para la tabla `reportes_usuarios`
--
ALTER TABLE `reportes_usuarios`
  ADD CONSTRAINT `reportes_usuarios_ibfk_1` FOREIGN KEY (`id_reportado`) REFERENCES `usuario` (`id_usuario`),
  ADD CONSTRAINT `reportes_usuarios_ibfk_2` FOREIGN KEY (`id_reportero`) REFERENCES `usuario` (`id_usuario`);
