...
if($_SERVER['REQUEST_METHOD']=='POST'){
					...
					mysqli_query($conexion,"INSERT into comentario VALUES(NULL,'$fecha','$comentario',$usuario,$id)");
						...
						while($resultCoemtario = mysqli_fetch_array($consultaComentario)){
							...
							echo "<div class='Comentario'><a href='Perfiles.php?id_usuario=".$id_usuario."'>".$resultUsuario['nombre_usuario']."</a><div class='contenido'>".$resultCoemtario['contenido']."</div><div class='fecha'>".$resultCoemtario['fecha']."</div></div>";
						}
